...
export const newReview = (reviewData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put("http://localhost:3000/api/v1/review", reviewData, {
            headers: {
...
export const getSliderProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://localhost:3000/api/v1/products/all');
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const config = { header: { "Content-Type": "application/json" } }
        const { data } = await axios.put(`http://localhost:3000/api/v1/admin/product/${id}`, productData, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
export const getAllReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:3000/api/v1/admin/reviews?id=${id}`
            , {
                headers: {
                    Authorization: `Bearer ${token}`
                }
...
export const deleteReview = (reviewId, productId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`http://localhost:3000/api/v1/admin/reviews?id=${reviewId}&productId=${productId}`);
